...
namespace FoodDeliveryTemplate.DataStores.MockDataStore
{
    ...
    public class RatingDataStore : BaseDataStore<Rating>, IRatingDataStore
    {
        ...
        public RatingDataStore()
        {
            ...
            {
                new Rating { Id = "ra001", Star = 3, PlaceId = "pl001", CustomerId = "cu001",
                ...
                new Rating { Id = "ra002", Star = 5, PlaceId = "pl002", CustomerId = "cu002",
                ...
                new Rating { Id = "ra003", Star = 5, PlaceId = "pl003", CustomerId = "cu001",
                ...
                new Rating { Id = "ra004", Star = 5, PlaceId = "pl004", CustomerId = "cu002",
                ...
                new Rating { Id = "ra005", Star = 4, PlaceId = "pl005", CustomerId = "cu001",
                ...
                new Rating { Id = "ra006", Star = 4, PlaceId = "pl006", CustomerId = "cu002",
                ...
                new Rating { Id = "ra011", Star = 2, PlaceId = "pl011", CustomerId = "cu001",
                ...
                new Rating { Id = "ra012", Star = 1, PlaceId = "pl012", CustomerId = "cu002",
                ...
                new Rating { Id = "ra013", Star = 3, PlaceId = "p013", CustomerId = "cu001",
                        DateGmt = new DateTime(2020, 8, 18), Text = "Aenean euismod dui vel pretium consequat." },

                new Rating { Id = "ra014", Star = 4, PlaceId = "pl014", CustomerId = "cu002",
                ...
                new Rating { Id = "ra015", Star = 3, PlaceId = "pl015", CustomerId = "cu001",
                        DateGmt = new DateTime(2020, 9, 29), Text = "Nullam maximus quis eros sed ultricies." },

                new Rating { Id = "ra016", Star = 5, PlaceId = "pl016", CustomerId = "cu002",
                        DateGmt = new DateTime(2020, 10, 7), Text = "Fusce a metus semper, suscipit erat in, aliquet mauris." },

                new Rating { Id = "ra017", Star = 3, PlaceId = "pl017", CustomerId = "cu001",
                ...
                new Rating { Id = "ra018", Star = 5, PlaceId = "pl018", CustomerId = "cu002",
                ...
                new Rating { Id = "ra019", Star = 4, PlaceId = "pl001", CustomerId = "cu001",
                ...
                new Rating { Id = "ra020", Star = 5, PlaceId = "pl002", CustomerId = "cu002",
                ...
                new Rating { Id = "ra021", Star = 4, PlaceId = "pl003", CustomerId = "cu001",
                ...
                new Rating { Id = "ra022", Star = 4, PlaceId = "pl004", CustomerId = "cu002",
                ...
                new Rating { Id = "ra027", Star = 2, PlaceId = "pl009", CustomerId = "cu001",
                ...
                new Rating { Id = "ra028", Star = 1, PlaceId = "pl010", CustomerId = "cu002",
                ...
                new Rating { Id = "ra029", Star = 3, PlaceId = "pl011", CustomerId = "cu001",
                        DateGmt = new DateTime(2021, 8, 28), Text = "Aenean euismod dui vel pretium consequat." },

                new Rating { Id = "ra030", Star = 4, PlaceId = "pl012", CustomerId = "cu002",
                ...
                new Rating { Id = "ra031", Star = 3, PlaceId = "pl013", CustomerId = "cu001",
                        DateGmt = new DateTime(2021, 9, 19), Text = "Nullam maximus quis eros sed ultricies." },

                new Rating { Id = "ra032", Star = 5, PlaceId = "pl014", CustomerId = "cu002",
